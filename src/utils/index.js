...
exports.generate_transformation_string = function(options) {
  ...
  if (isObject(border)) {
    border = `${(ref = border.width) != null ? ref : 2}px_solid_${((ref1 = border.color) != null ? ref1 : "black").replace(/^#/, 'rgb:')}`;
...
smart_escape = function(string, unsafe = /([^a-zA-Z0-9_.\-\/:]+)/g) {
...
exports.api_url = function(action = 'upload', options = {}) {
...
split_range = function(range) { // :nodoc:
...
norm_range_value = function(value) { // :nodoc:
  var modifier, offset;
...
exports.only = function(hash, ...keys) {
