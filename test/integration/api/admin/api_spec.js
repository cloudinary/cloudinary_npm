...
describe("oauth_token", function(){
  it("should send the oauth_token option to the server", function() {
    return helper.provideMockObjects((mockXHR, writeSpy, requestSpy) => {
  ...
  it("should send the oauth_token config to the server", function() {
    return helper.provideMockObjects((mockXHR, writeSpy, requestSpy) => {
      cloudinary.config({
        api_key: null,
        api_secret: null,
  ...
  it("should fail when missing all credentials", function() {
    cloudinary.config({
      api_key: null,
      api_secret: null,
      oauth_token: null
  ...
  it("Test oauth_token as only option", function() {
    cloudinary.config({
      api_key: null,
      api_secret: null
    });
  ...
  it("oauth_token as option should take priority with secret and key", function() {
    cloudinary.config({
      api_key: '1234',
      api_secret: '1234'
    });
  ...
  it("oauth_token as config should take priority with secret and key", function() {
    cloudinary.config({
      api_key: '123',
      api_secret: '123',
      oauth_token: 'MTQ0NjJkZmQ5OTM2NDE1ZTZjNGZmZjI4'
