...
describe('source helper', () => {
  ...
  it("should generate source tag with media query", () => {
    const media = { min_width, max_width };
    const tag = cloudinary.source(FULL_PUBLIC_ID, {
      media,
    });
    const expectedMedia = `(min-width: ${min_width}px) and (max-width: ${max_width}px)`;
    const expectedTag = `<source media='${expectedMedia}' srcset='${UPLOAD_PATH}/sample.jpg'>`;
  ...
  it("should generate picture tag", () => {
    const tag = cloudinary.picture(FULL_PUBLIC_ID, extend({
      sources: [
        {
          max_width: min_width,
          transformation: {
    ...
    const exp_tag = "<picture><source media='(max-width: 100px)' srcset='http://res.cloudinary.com/test123/image/upload/c_fill,h_399,w_399/a_17,e_sepia,w_100/sample.jpg'><source media='(min-width: 100px) and (max-width: 399px)' srcset='http://res.cloudinary.com/test123/image/upload/c_fill,h_399,w_399/a_18,e_colorize,w_399/sample.jpg'><source media='(min-width: 399px)' srcset='http://res.cloudinary.com/test123/image/upload/c_fill,h_399,w_399/a_19,e_blur,w_399/sample.jpg'><img src='http://res.cloudinary.com/test123/image/upload/c_fill,h_399,w_399/sample.jpg' height='399' width='399'/></picture>";
