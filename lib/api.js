...
exports.resource = function resource(public_id, callback, options={}) {
  ...
  return call_api("get", uri, only(options, "exif", "colors", "faces", "image_metadata", "pages", "phash", "coordinates", "max_results", "next_cursor", "derived_next_cursor"), callback, options);
};
