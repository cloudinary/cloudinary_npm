...
(function() {
  ...
  exports.delete_resources = function(public_ids, callback, options) {
    ...
    return call_api("delete", uri, _.extend({
      "public_ids[]": public_ids
    }, api.only(options, "keep_original", "invalidate", "transformations")), callback, options);
  };
  ...
  exports.delete_resources_by_prefix = function(prefix, callback, options) {
    ...
    return call_api("delete", uri, _.extend({
      prefix: prefix
    }, api.only(options, "keep_original", "next_cursor", "invalidate", "transformations")), callback, options);
  };
  ...
  exports.delete_resources_by_tag = function(tag, callback, options) {
    ...
    resource_type = (ref = options["resource_type"]) != null ? ref : "image";
    uri = ["resources", resource_type, "tags", tag];
    return call_api("delete", uri, api.only(options, "keep_original", "next_cursor", "invalidate", "transformations"), callback, options);
  };
