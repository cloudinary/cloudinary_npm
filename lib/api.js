...
exports.create_metadata_field = function create_metadata_field(metadata, callback, options = {}) {
  options.content_type = "json";
...
exports.delete_metadata_field = function delete_metadata_field(external_id, callback, options = {}) {
  return call_api("delete", "metadata_fields/" + external_id, {}, callback, options);
};

exports.get_metadata_field = function get_metadata_field(external_id, callback, options = {}) {
  return call_api("get", "metadata_fields/" + external_id, {}, callback, options);
};

exports.update_metadata_field = function update_metadata_field(external_id, metadata, callback, options = {}) {
  const params = only(metadata, "external_id", "type", "label", "mandatory", "default_value", "validation", "datasource");
  options.content_type = "json";
  return call_api("put", "metadata_fields/" + external_id, params, callback, options);
};

exports.update_metadata_field_datasource = function update_metadata_field_datasource(external_id, datasource, callback, options = {}) {
  const params = only(datasource, "values");
  options.content_type = "json";
  return call_api("put", "metadata_fields/" + external_id + "/datasource", params, callback, options);
};

exports.delete_entries_field_datasource = function delete_entries_field_datasource(external_id, callback, options = {}) {
  const params = only(options, "external_id", "external_ids");
  options.content_type = "json";
