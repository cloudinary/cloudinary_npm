...
exports.update_metadata_field = function update_metadata_field(external_id, callback, options = {}) {
  const params = only(options, "external_id", "type", "label", "mandatory", "default_value", "validation", "datasource");
  options.content_type = "json";
  return call_api("put", "metadata_fields/" + external_id, params, callback, options);
};

exports.update_metadata_field_datasource = function update_metadata_field_datasource(external_id, callback, options = {}) {
  const params = only(options, "values");
  options.content_type = "json";
