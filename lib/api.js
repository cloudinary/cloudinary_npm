...
const { extend, pick } = utils;

const TRANSFORMATIONS_URI = "transformations";

function deleteResourcesParams(options, params = {}) {
  return extend(params, pick(options, "keep_original", "invalidate", "next_cursor", "transformations"));
}
...
exports.resources = function resources(callback, options = {}) {
  ...
  return call_api("get", uri, pick(options, "next_cursor", "max_results", "prefix", "tags", "context", "direction", "moderations", "start_at"), callback, options);
};
...
exports.resources_by_tag = function resources_by_tag(tag, callback, options = {}) {
  ...
  return call_api("get", uri, pick(options, "next_cursor", "max_results", "tags", "context", "direction", "moderations"), callback, options);
};
...
exports.resources_by_context = function resources_by_context(key, value, callback, options = {}) {
  ...
  params = pick(options, "next_cursor", "max_results", "tags", "context", "direction", "moderations");
  params.key = key;
  if (value != null) {
    params.value = value;
  }
...
exports.resources_by_ids = function resources_by_ids(public_ids, callback, options = {}) {
  ...
  params = pick(options, "tags", "context", "moderations");
...
exports.resource = function resource(public_id, callback, options = {}) {
  ...
  return call_api("get", uri, pick(options, "exif", "colors", "derived_next_cursor", "faces", "image_metadata", "pages", "phash", "coordinates", "max_results"), callback, options);
};
...
exports.tags = function tags(callback, options = {}) {
  ...
  return call_api("get", uri, pick(options, "next_cursor", "max_results", "prefix"), callback, options);
};

exports.transformations = function transformations(callback, options = {}) {
  const params = pick(options, "next_cursor", "max_results", "named");
...
exports.transformation = function transformation(transformationName, callback, options = {}) {
  const params = pick(options, "next_cursor", "max_results");
...
exports.update_transformation = function update_transformation(transformationName, updates, callback, options = {}) {
  const params = pick(updates, "allowed_for_strict");
  params.transformation = utils.build_eager(transformationName);
...
exports.upload_presets = function upload_presets(callback, options = {}) {
  return call_api("get", ["upload_presets"], pick(options, "next_cursor", "max_results"), callback, options);
};
...
exports.update_upload_preset = function update_upload_preset(name, callback, options = {}) {
  let params, uri;
  uri = ["upload_presets", name];
  params = utils.merge(utils.clear_blank(utils.build_upload_params(options)), pick(options, "unsigned", "disallow_public_id", "live"));
...
exports.create_upload_preset = function create_upload_preset(callback, options = {}) {
  let params, uri;
  uri = ["upload_presets"];
  params = utils.merge(utils.clear_blank(utils.build_upload_params(options)), pick(options, "name", "unsigned", "disallow_public_id", "live"));
  return call_api("post", uri, params, callback, options);
};
...
exports.upload_mappings = function upload_mappings(callback, options = {}) {
  let params;
  params = pick(options, "next_cursor", "max_results");
...
function publishResource(byKey, value, callback, options = {}) {
  let params, resource_type, uri;
  params = pick(options, "type", "invalidate", "overwrite");
  params[byKey] = value;
  resource_type = options.resource_type || "image";
...
exports.add_metadata_field = function add_metadata_field(field, callback, options = {}) {
  const params = pick(field, "external_id", "type", "label", "mandatory", "default_value", "validation", "datasource");
  options.content_type = "json";
...
exports.update_metadata_field_datasource = function update_metadata_field_datasource(field_external_id, entries_external_id, callback, options = {}) {
  const params = pick(entries_external_id, "values");
  options.content_type = "json";
