...
exports.resource = function resource(public_id, callback, options = {}) {
  ...
  return call_api("get", uri, only(options, "exif", "cinemagraph_analysis", "colors", "derived_next_cursor", "faces", "image_metadata", "pages", "phash", "coordinates", "max_results"), callback, options);
};
