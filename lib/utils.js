...
(function() {
  var CLOUDINARY_JS_CONFIG_PARAMS, DEFAULT_RESPONSIVE_WIDTH_TRANSFORMATION, LAYER_KEYWORD_PARAMS, _, config, crc32, crypto, finalize_resource_type, finalize_source, join_pair, norm_range_value, number_pattern, offset_any_pattern, offset_any_pattern_re, process_layer, process_video_params, querystring, smart_escape, split_range, textStyle, unsigned_url_prefix, utf8_encode, utils, v1_adapter, v1_result_adapter,
    slice = [].slice;
