...
(function() {
  var CLOUDINARY_JS_CONFIG_PARAMS, CONDITIONAL_OPERATORS, DEFAULT_RESPONSIVE_WIDTH_TRANSFORMATION, LAYER_KEYWORD_PARAMS, PREDEFINED_VARS, build_custom_headers, build_eager, clone, compact, config, crc32, crypto, extend, filter, finalize_resource_type, finalize_source, first, generate_token, hashToQuery, identity, isArray, isEmpty, isFunction, isObject, isPlainObject, isString, isUndefined, join_pair, last, map, merge, norm_range_value, normalize_expression, number_pattern, offset_any_pattern, offset_any_pattern_re, process_if, process_layer, process_video_params, querystring, smart_escape, sortBy, split_range, take, textStyle, unsigned_url_prefix, url, utf8_encode, utils, v1_adapter, v1_result_adapter,
    slice = [].slice;
