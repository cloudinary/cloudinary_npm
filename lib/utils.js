...
(function() {
  var CLOUDINARY_JS_CONFIG_PARAMS, DEFAULT_RESPONSIVE_WIDTH_TRANSFORMATION, _, config, crc32, crypto, finalize_resource_type, finalize_source, join_pair, norm_range_value, number_pattern, offset_any_pattern, offset_any_pattern_re, process_video_params, querystring, smart_escape, split_range, unsigned_url_prefix, utf8_encode, utils, v1_adapter, v1_result_adapter,
    slice = [].slice;
  ...
  exports.generate_transformation_string = function(options) {
    var angle, background, base_transformation, base_transformations, border, color, crop, dpr, effect, flags, has_layer, height, j, key, keys, len, named_transformation, no_html_sizes, param, params, range_value, ref, ref1, ref2, ref3, ref4, ref5, responsive_width, responsive_width_transformation, result, short, simple_params, size, sortedParams, transformations, value, width;
