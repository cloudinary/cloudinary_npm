...
/**
 * @desc - Return an array of all sub-accounts, or if conditions are specified, return the relevant sub-accounts.
 ...
 * @param [options] {object} - @see <a href="https://cloudinary.com/documentation/cloudinary_sdks#configuration_parameters" target="_blank">Documentation</a>
...
/**
 * @desc Return all enabled sub-accounts with a name that begins with 'product':
...
/**
 * @desc - Update the the specified details of the sub-account.
...
/**
 * @desc Return the user with the specified ID.
...
/**
 * @desc - Delete a user with the specified ID
...
/**
 * @desc - Create a new user group for the account.
...
/**
 * @desc Update the name of a specified user group.
...
/**
 * @desc Delete a user group with the specified ID.
...
/**
 * @desc Add a user to a group with the specified ID.
...
/**
 * @desc Remove a user from a group with the specified ID.
 * @param group_id {string} - The ID of the user group.
 * @param user_id {string} - The ID of the user.
 * @param [options] {object} - @see <a href="https://cloudinary.com/documentation/cloudinary_sdks#configuration_parameters" target="_blank">Documentation</a>
 * @param [callback] {function}
...
/**
 * @desc - Return a user group with the specified ID.
...
/**
 * @desc - Return an array of all user groups in the account.
 * @param [options] {object} - @see <a href="https://cloudinary.com/documentation/cloudinary_sdks#configuration_parameters" target="_blank">Documentation</a>
 * @param [callback] {function}
 */
