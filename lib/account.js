...
const call_api = require('./network/accountRequest');
...
function subAccounts(enabled, ids = [], prefix, options = {}, callback) {
  ...
  let uri = ['provisioning', 'accounts', config().account_id, 'sub_accounts'];
  // TODO do we want to support a custom account_id? probably...
  return call_api('GET', uri, params, callback, options);
}

function subAccount(subAccountId, options = {}, callback) {
  // TODO do we want to support a custom account_id? probably...
  let uri = ['provisioning', 'accounts', config().account_id, 'sub_accounts', subAccountId];
...
function updateSubAccount(subAccountId, name, cloudName, custoAttributes, enabled, options = {}, callback) {

}

// get user
function user(userId, options = {}, callback) {
  let uri = ['provisioning', 'accounts', config().account_id, 'users', userId];
  return call_api('GET', uri, {}, callback, options);
}

// get users
function users(pending, userIds, prefix, subAccountId, options = {}, callback) {
  let uri = ['provisioning', 'accounts', config().account_id, 'users'];
  return call_api('GET', uri, {}, callback, options);
}
...
function createUserGroup(name, options = {}, callback) {
  let uri = ['provisioning', 'accounts', config().account_id, 'user_groups'];
}

function updateUserGroup(groupId, name, options = {}, callback) {
  let uri = ['provisioning', 'accounts', config().account_id, 'user_groups', groupId];
}
...
function userGroup(groupId, userId, options = {}, callback) {
