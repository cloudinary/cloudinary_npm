...
(function() {
  var EncodeFieldPart, EncodeFilePart, MyChunker, Q, TEXT_PARAMS, UploadStream, Writable, _, build_upload_params, call_api, call_tags_api, config, fs, https, path, post, util, utils;
  ...
  MyChunker.prototype._write = function(data, encoding, done) {
    var grab;
    if (!this.active) {
      return done();
    }
  ...
  exports.upload_chunked_stream = function(callback, options) {
    var chunk_size, chunker, params, ref, ref1, sent;
    if (options == null) {
      options = {};
    }
    ...
    params = build_upload_params(options);
    chunk_size = (ref = (ref1 = options.chunk_size) != null ? ref1 : options.part_size) != null ? ref : 20000000;
    chunker = new MyChunker({
