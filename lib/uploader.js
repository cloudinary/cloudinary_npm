...
(function() {
  ...
  exports.upload_stream = function(callback, options) {
    ...
    return exports.upload(null, callback, _.assignIn({
      stream: true
    }, options));
  };
  ...
  exports.upload_large = function(path, callback, options) {
    ...
    return exports.upload_chunked(path, callback, _.assignIn({
      resource_type: 'raw'
    }, options));
  };
  ...
  exports.upload_large_stream = function(_unused_, callback, options) {
    ...
    return exports.upload_chunked_stream(callback, _.assignIn({
      resource_type: 'raw'
    }, options));
  };
  ...
  exports.direct_upload = function(callback_url, options) {
    ...
    params = build_upload_params(_.assignIn({
